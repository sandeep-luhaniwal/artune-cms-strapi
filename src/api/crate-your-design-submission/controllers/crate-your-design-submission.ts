/**
 * crate-your-design-submission controller
 */

import { factories } from '@strapi/strapi';
import ExcelJS from 'exceljs';

export default factories.createCoreController('api::crate-your-design-submission.crate-your-design-submission', ({ strapi }) => ({
  async exportSubmissions(ctx) {
    try {
      const submissions = await strapi.documents('api::crate-your-design-submission.crate-your-design-submission').findMany({
        limit: 10000,
      });
      ...
      ctx.set('Content-Disposition', 'attachment; filename=crate_your_design_submissions.xlsx');
      ctx.body = buffer;
    } catch (error: any) {
      strapi.log.error('Error exporting crate your design submissions:', error);
  ...
  async create(ctx) {
    try {
      ...
      const apiUid = 'api::crate-your-design-submission.crate-your-design-submission';
      const entryData = {
